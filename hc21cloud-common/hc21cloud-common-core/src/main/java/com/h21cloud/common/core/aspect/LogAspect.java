package com.h21cloud.common.core.aspect;

import com.h21cloud.common.core.support.wrapper.Wrapper;
...
public class LogAspect {
     ...
     * 切点.
     */
    @Pointcut("@annotation(com.h21cloud.common.core.anno.Logging)")
    public void logging() {
    }
